...
exports.RedirectToNodeLogs = react_1.injectI18n(({ match: { params: { nodeId, nodeType }, }, location, intl, }) => (react_2.default.createElement(with_source_1.WithSource, null, ({ configuredFields }) => {
    if (!configuredFields) {
    ...
    const searchString = compose_1.default(with_log_filter_1.replaceLogFilterInQueryString(`${configuredFields[nodeType]}: ${nodeId}`), with_log_position_1.replaceLogPositionInQueryString(query_params_1.getTimeFromLocation(location)))('');
