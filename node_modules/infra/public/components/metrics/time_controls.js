...
class MetricsTimeControls extends react_2.default.Component {
    ...
    render() {
        ...
        return (react_2.default.createElement(MetricsTimeControlsContainer, null,
            react_2.default.createElement(range_date_picker_1.RangeDatePicker, { key: `${currentTimeRange.from}-${currentTimeRange.to}`, startDate: moment_1.default(currentTimeRange.from), endDate: moment_1.default(currentTimeRange.to), onChangeRangeTime: this.handleChangeDate, isLoading: isLiveStreaming, disabled: isLiveStreaming, recentlyUsed: recentlyUsed, ref: this.dateRangeRef }),
            appendButton));
    }
}
