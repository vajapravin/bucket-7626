...
const MessageDeprecation = ({ deprecation, }) => {
    ...
    return (react_1.default.createElement(cell_1.DeprecationCell, { headline: deprecation.message, healthColor: constants_1.COLOR_MAP[deprecation.level], actions: deprecation.actions, docUrl: deprecation.url, items: items }));
};
/**
