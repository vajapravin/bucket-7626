...
class CheckupTab extends types_1.UpgradeAssistantTabComponent {
    ...
    render() {
        const { alertBanner, checkupLabel, deprecations, loadingState, refreshCheckupData, setSelectedTabIndex, showBackupWarning = false, } = this.props;
