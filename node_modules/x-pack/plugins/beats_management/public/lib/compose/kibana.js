...
function compose() {
    ...
    const tags = new tags_1.TagsLib(new rest_tags_adapter_1.RestTagsAdapter(api), config_schemas_translations_map_1.getSupportedConfig());
    ...
    const framework = new framework_1.FrameworkLib(new kibana_framework_adapter_1.KibanaFrameworkAdapter(plugin_1.PLUGIN.ID, management_1.management, routes_1.default, chrome_1.default.getBasePath, onKibanaReady, xpack_info_1.XPackInfoProvider, chrome_1.default.getUiSettingsClient()));
    const libs = {
        framework,
