...
function compose(mockIsKueryValid, mockKueryToEsQuery, suggestions) {
    ...
    const tags = new tags_1.TagsLib(new memory_tags_adapter_1.MemoryTagsAdapter([]), config_schemas_translations_map_1.getSupportedConfig());
    ...
    const framework = new framework_1.FrameworkLib(new kibana_framework_adapter_1.KibanaFrameworkAdapter(pluginUIModule, management_1.management, routes_1.default, () => '', onKibanaReady, null, null));
    const libs = {
        framework,
