...
class InitialWalkthroughPageComponent extends react_2.Component {
    render() {
        ...
        if (this.props.location.pathname === '/walkthrough/initial') {
            return (react_2.default.createElement(no_data_1.NoDataLayout, { title: "Beats central management", actionSection: react_2.default.createElement(connected_link_1.ConnectedLink, { path: "/walkthrough/initial/beat" },
