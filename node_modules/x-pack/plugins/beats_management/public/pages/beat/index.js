...
class BeatDetailsPageComponent extends react_2.default.PureComponent {
    ...
    renderActionSection(beat) {
        return beat ? (react_2.default.createElement(eui_1.EuiFlexGroup, null,
            ...
            beat.full_tags && beat.full_tags.length > 0 && (react_2.default.createElement(eui_1.EuiFlexItem, { grow: false },
                react_2.default.createElement(eui_1.EuiText, { size: "xs" },
                    react_2.default.createElement(react_1.FormattedMessage, { id: "xpack.beatsManagement.beat.lastConfigUpdateMessage", defaultMessage: "Last Config Update: {lastUpdateTime}.", values: {
                            lastUpdateTime: (react_2.default.createElement("strong", null, moment_1.default(lodash_1.first(lodash_1.sortByOrder(beat.full_tags, 'last_updated')).last_updated).fromNow())),
    ...
    render() {
        ...
        return (react_2.default.createElement(primary_1.PrimaryLayout, { title: title, actionSection: this.renderActionSection(beat), hideBreadcrumbs: this.props.libs.framework.info.k7Design },
