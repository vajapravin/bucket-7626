...
class MainPageComponent extends react_2.default.PureComponent {
    ...
    render() {
        return (react_2.default.createElement(primary_1.PrimaryLayout, { title: "Beats", hideBreadcrumbs: this.props.libs.framework.info.k7Design }, (renderAction) => (react_2.default.createElement(unstated_1.Subscribe, { to: [beats_1.BeatsContainer, tags_1.TagsContainer] }, (beats, tags) => (react_2.default.createElement(react_2.default.Fragment, null,
