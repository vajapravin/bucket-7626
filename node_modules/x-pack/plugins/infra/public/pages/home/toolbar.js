...
exports.HomeToolbar = react_1.injectI18n(({ intl }) => (react_2.default.createElement(toolbar_1.Toolbar, null,
    ...
    react_2.default.createElement(eui_1.EuiFlexGroup, { alignItems: "center", justifyContent: "spaceBetween", gutterSize: "m" },
        ...
        react_2.default.createElement(with_waffle_options_1.WithWaffleOptions, null, ({ changeMetric, changeGroupBy, groupBy, metric, nodeType }) => (react_2.default.createElement(react_2.default.Fragment, null,
            ...
            react_2.default.createElement(eui_1.EuiFlexItem, { grow: false },
                react_2.default.createElement(waffle_group_by_controls_1.WaffleGroupByControls, { groupBy: groupBy, nodeType: nodeType, onChange: changeGroupBy }))))),
        react_2.default.createElement(eui_1.EuiFlexItem, { grow: false },
