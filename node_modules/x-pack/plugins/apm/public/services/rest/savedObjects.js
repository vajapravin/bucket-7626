...
exports.getAPMIndexPattern = lodash_1.memoize(async () => {
    ...
    if (lodash_1.isEmpty(res.savedObjects)) {
        return;
    }
    const apmSavedObject = lodash_1.first(res.savedObjects.filter(savedObject => savedObject.attributes.title === apmIndexPatternTitle));
