...
exports.DiscoverTransactionButton = ({ transaction, children }) => {
    return (react_1.default.createElement(DiscoverButton_1.DiscoverButton, { query: getDiscoverQuery(transaction), children: children }));
};
