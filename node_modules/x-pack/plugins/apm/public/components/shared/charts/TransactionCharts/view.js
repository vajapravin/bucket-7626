...
class TransactionChartsView extends react_1.Component {
    constructor() {
        ...
        this.getResponseTimeTickFormatter = (t) => {
            return this.props.charts.noHits ? '- ms' : formatters_1.asMillis(t);
        };
        this.getResponseTimeTooltipFormatter = (p) => {
            return this.props.charts.noHits || !p ? '- ms' : formatters_1.asMillis(p.y);
        };
        ...
        return (react_1.default.createElement(eui_1.EuiFlexItem, { grow: false },
            react_1.default.createElement(ShiftedEuiText, { size: "xs" },
                react_1.default.createElement(ShiftedIconWrapper, null,
                    react_1.default.createElement(eui_1.EuiIconTip, { content: "The stream around the average duration shows the expected bounds. An annotation is shown for anomaly scores >= 75." })),
                react_1.default.createElement("span", null, "Machine learning: "),
                react_1.default.createElement(url_1.ViewMLJob, { serviceName: serviceName, transactionType: transactionType, location: this.props.location }))));
    }
    render() {
