...
class TransactionOverviewView extends react_1.default.Component {
    constructor() {
        ...
        this.handleTypeChange = (event) => {
            ...
            const type = url_1.legacyEncodeURIComponent(event.target.value);
            history.push({
                ...location,
    ...
    render() {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            serviceTransactionTypes.length > 1 ? (react_1.default.createElement(eui_1.EuiFormRow, null,
            ...
            react_1.default.createElement(transactionList_1.TransactionListRequest, { urlParams: urlParams, render: ({ data }) => react_1.default.createElement(List_1.default, { items: data, serviceName: serviceName }) })));
    }
}
