...
exports.TransactionSelect = ({ existingJobs, types, selected, onChange }) => {
    return (react_1.default.createElement(eui_1.EuiFormRow, { label: "Select a transaction type for this job" },
        react_1.default.createElement(eui_1.EuiSuperSelect, { valueOfSelected: selected, onChange: onChange, options: types.map((type, i) => ({
                ...
                dropdownDisplay: (react_1.default.createElement(eui_1.EuiFlexGroup, { justifyContent: "spaceBetween" },
                    ...
                    react_1.default.createElement(eui_1.EuiFlexItem, { grow: false }, Boolean(existingJobs.find(job => job.jobId && job.jobId.includes(type))) ? (react_1.default.createElement(eui_1.EuiToolTip, { content: "ML job exists for this type" },
