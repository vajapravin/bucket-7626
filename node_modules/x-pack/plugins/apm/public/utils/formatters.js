...
const SPACE = ' ';
const notAvailableLabel = i18n_1.i18n.translate('xpack.apm.formatters.notAvailableLabel', {
    defaultMessage: 'N/A'
});
function asSeconds(value, { withUnit = true, defaultValue = notAvailableLabel } = {}) {
    if (value == null) {
        return defaultValue;
    }
...
function asMillis(value, { withUnit = true, defaultValue = notAvailableLabel } = {}) {
    if (value == null) {
        return defaultValue;
    }
...
function asMicros(value, { withUnit = true, defaultValue = notAvailableLabel } = {}) {
    if (value == null) {
        return defaultValue;
    }
...
function asTime(value, { withUnit = true, defaultValue = notAvailableLabel } = {}) {
    if (value == null) {
        return defaultValue;
    }
