...
class ReportListingUi extends react_2.Component {
    ...
    render() {
        return (react_2.default.createElement(eui_1.EuiPage, null,
            react_2.default.createElement(eui_1.EuiPageBody, { restrictWidth: true },
        ...
        const tableColumns = [
            ...
            },
            {
                ...
                render: (status, record) => {
                    ...
                    const statusLabel = jobStatusLabelsMap.get(status) || status;
                    if (statusTimestamp) {
                        return (react_2.default.createElement("div", null,
