...
var EmbeddedVisualizeHandler = /** @class */ (function () {
    function EmbeddedVisualizeHandler(element, savedObject, params) {
        ...
        var appState = params.appState, uiState = params.uiState, queryFilter = params.queryFilter, timeRange = params.timeRange, filters = params.filters, query = params.query, Private = params.Private, autoFetch = params.autoFetch;
