...
var VisualizeDataLoader = /** @class */ (function () {
    ...
    VisualizeDataLoader.prototype.fetch = function (params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var minimalColumns, requestHandlerResponse, canSkipResponseHandler, _a, error_1;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.requestHandler(tslib_1.__assign({ partialRows: this.vis.type.requiresPartialRows || this.vis.params.showPartialRows, minimalColumns: minimalColumns, metricsAtAllLevels: this.vis.isHierarchical(), visParams: this.vis.params }, params, { filters: params.filters
