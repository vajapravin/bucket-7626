...
export var SuggestionComponent = function (props) {
    return (React.createElement("div", { className: classNames({
        ...
        React.createElement("div", { className: 'suggestionItem suggestionItem--' + props.suggestion.type },
            React.createElement("div", { className: "suggestionItem__type" },
                React.createElement(EuiIcon, { type: getEuiIconType(props.suggestion.type) })),
            React.createElement("div", { className: "suggestionItem__text" }, props.suggestion.text),
            React.createElement("div", { className: "suggestionItem__description", 
