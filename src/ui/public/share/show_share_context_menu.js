...
export function showShareContextMenu(_a) {
    ...
    var element = (React.createElement(I18nProvider, null,
        React.createElement(EuiWrappingPopover, { className: "navbar__popover", id: "sharePopover", button: anchorElement, isOpen: true, closePopover: onClose, panelPaddingSize: "none", withTitle: true },
