...
import { EuiFieldSearch, EuiFlexGroup, EuiFlexItem, EuiKeyPadMenu, EuiKeyPadMenuItemButton, EuiModalHeader, EuiModalHeaderTitle, EuiSpacer, EuiTitle, } from '@elastic/eui';
                    ...
                    React.createElement(EuiFlexItem, null,
                        React.createElement(EuiFlexGroup, { className: "visNewVisDialog__list", direction: "column", gutterSize: "none", responsive: false },
                            React.createElement(EuiFlexItem, { grow: false, className: "visNewVisDialog__searchWrapper" },
                                React.createElement(EuiFieldSearch, { placeholder: "Filter", value: query, onChange: this.onQueryChange, fullWidth: true })),
