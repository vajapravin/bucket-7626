  ...
  return {
    ...
    'query:queryString:options': {
      ...
      description: _i18n.i18n.translate('kbn.advancedSettings.query.queryStringOptionsText', {
        ...
        values: {
          optionsLink: '<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-query-string-query.html" target="_blank" rel="noopener noreferrer">' + _i18n.i18n.translate('kbn.advancedSettings.query.queryStringOptions.optionsLinkText', {
    ...
    'k7design': {
      name: _i18n.i18n.translate('kbn.advancedSettings.k7designTitle', {
        defaultMessage: 'Use the new K7 UI design'
      }),
      value: false,
      description: _i18n.i18n.translate('kbn.advancedSettings.k7designText', {
        defaultMessage: 'When set, Kibana will use the new K7 design targeted for release in 7.0. At this time, not all features are implemented.'
      })
    },
    'search:queryLanguage': {
      name: _i18n.i18n.translate('kbn.advancedSettings.searchQueryLanguageTitle', {
        defaultMessage: 'Query language'
      }),
      value: 'lucene',
      description: _i18n.i18n.translate('kbn.advancedSettings.searchQueryLanguageText', {
        defaultMessage: 'Query language used by the query bar. Kuery is an experimental new language built specifically for Kibana.'
      }),
      type: 'select',
    ...
    'sort:options': {
      ...
      description: _i18n.i18n.translate('kbn.advancedSettings.sortOptionsText', {
        ...
        values: {
          optionsLink: '<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/search-request-sort.html" target="_blank" rel="noopener noreferrer">' + _i18n.i18n.translate('kbn.advancedSettings.sortOptions.optionsLinkText', {
            defaultMessage: 'Options'
          }) + '</a>'
        }
      }),
    ...
    'courier:customRequestPreference': {
      ...
      description: _i18n.i18n.translate('kbn.advancedSettings.courier.customRequestPreferenceText', {
        ...
        values: {
          ...
          requestPreferenceLink: '<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/search-request-preference.html" target="_blank" rel="noopener noreferrer">' + _i18n.i18n.translate('kbn.advancedSettings.courier.customRequestPreference.requestPreferenceLinkText', {
            defaultMessage: 'Request Preference'
          }) + '</a>'
        }
      }),
      ...
      description: _i18n.i18n.translate('kbn.advancedSettings.visualization.tileMap.maxPrecisionText', {
        ...
        values: {
          cellDimensionsLink: `<a href="http://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-bucket-geohashgrid-aggregation.html#_cell_dimensions_at_the_equator"
            target="_blank" rel="noopener noreferrer">` + _i18n.i18n.translate('kbn.advancedSettings.visualization.tileMap.maxPrecision.cellDimensionsLinkText', {
  ...
  "value": 0
    ...
    'timepicker:quickRanges': {
      ...
      description: _i18n.i18n.translate('kbn.advancedSettings.timepicker.quickRangesText', {
        defaultMessage: 'The list of ranges to show in the Quick section of the time picker. This should be an array of objects, ' + 'with each object containing "from", "to" (see {acceptedFormatsLink}), ' + '"display" (the title to be displayed), and "section" (which column to put the option in).',
        ...
        values: {
          acceptedFormatsLink: `<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/common-options.html#date-math"
            target="_blank" rel="noopener noreferrer">` + _i18n.i18n.translate('kbn.advancedSettings.timepicker.quickRanges.acceptedFormatsLinkText', {
    ...
    'dashboard:defaultDarkTheme': {
      name: _i18n.i18n.translate('kbn.advancedSettings.dashboardDarkThemeTitle', {
        defaultMessage: 'Dark theme'
      }),
      value: false,
      description: _i18n.i18n.translate('kbn.advancedSettings.dashboardDarkThemeText', {
      ...
      description: _i18n.i18n.translate('kbn.advancedSettings.notifications.bannerText', {
        ...
        values: {
          markdownLink: `<a href="https://help.github.com/articles/basic-writing-and-formatting-syntax/"
            target="_blank" rel="noopener noreferrer">` + _i18n.i18n.translate('kbn.advancedSettings.notifications.banner.markdownLinkText', {
