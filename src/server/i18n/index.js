...
async function i18nMixin(kbnServer, server, config) {
  ...
  const translationsDirs = [(0, _utils.fromRoot)('src/ui/translations')];
  ...
  const pureTranslations = await _i18n.i18nLoader.getTranslationsByLocale(locale);
  const translations = Object.freeze(_extends({
    locale
  }, pureTranslations));

  _i18n.i18n.init(translations);
